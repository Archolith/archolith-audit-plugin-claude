# Archolith Skree — Claude Code Plugin

Live MCP token usage audit (Archolith Skree) for Claude Code sessions. Tracks per-server token spend and waste patterns in real time.
